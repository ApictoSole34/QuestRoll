            ...
            if (obj instanceof ItemEntity) {
                ...
                holder.selectButton.setOnClickListener(v -> {
                    ...
                    if (addToBackground) {
                        ...
                        Toast.makeText(getContext(), "Dodano do backgroundu: " + item.name, Toast.LENGTH_SHORT).show();
                    } else if (addToClass) {
                        viewModel.classEquipment.add(dtoItem);
                        Toast.makeText(getContext(), "Dodano do klasy: " + item.name, Toast.LENGTH_SHORT).show();
                    }
                    NavController navController = Navigation.findNavController(v);
                    navController.popBackStack();
                });
    ...
    private void showItemSetSelectionDialog(ItemSetEntity set) {
        new Thread(() -> {
            ...
            requireActivity().runOnUiThread(() -> {
                ...
                builder.setPositiveButton("Dodaj zaznaczone", (dialog, which) -> {
