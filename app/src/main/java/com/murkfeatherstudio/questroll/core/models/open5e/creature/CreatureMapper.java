...
public class CreatureMapper implements Mapper<CreatureEntity, CreatureDto> {

    @Override
    public CreatureEntity toEntity(CreatureDto dto) {
    ...
    private String formatChallengeRatingText(float cr) {
