package com.murkfeatherstudio.questroll.core.models.custom.custom_character_class;
...
public class CustomCharacterClassEntity {
    ...
    /**
     * JSON representing multiclassing prerequisites (e.g., {"STR": 13, "DEX": 13}).
     */
    @ColumnInfo(name = "multiclass_prereqs_json")
    public String multiclassPrereqsJson = "{}";
}