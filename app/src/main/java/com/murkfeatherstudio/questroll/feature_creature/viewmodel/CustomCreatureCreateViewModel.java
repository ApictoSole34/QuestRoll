    ...
    public void save(CustomCreatureEntity entity) {
        executor.execute(() -> {
            try {
                ...
                // Correct D&D 5e modifier calculation for passive perception and initiative
                int wisMod = CharacterEngine.getAbilityModifier(entity.wis);
                entity.passivePerception = 10 + wisMod;
                entity.initiativeBonus = CharacterEngine.getAbilityModifier(entity.dex);
