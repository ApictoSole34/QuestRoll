...
public class CharacterCreatorViewModel extends AndroidViewModel {
    ...
    public CharacterCreatorViewModel(Application app) {
        this(app, Open5eDatabase.getInstance(app), PlayerCharacterDatabase.getInstance(app));
    }

    @VisibleForTesting
    public CharacterCreatorViewModel(Application app, Open5eDatabase open5eDb, PlayerCharacterDatabase pcDb) {
        super(app);
