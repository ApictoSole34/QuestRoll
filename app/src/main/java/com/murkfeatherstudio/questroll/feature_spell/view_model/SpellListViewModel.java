...
public class SpellListViewModel extends ViewModel {
    ...
    public SpellListViewModel(SpellDao spellDao,
        ...
        Observer<Object> refreshSchoolNames = ignored -> AppExecutors.getInstance().diskIO().execute(() -> {
    ...
    public void loadSchools() {
        AppExecutors.getInstance().diskIO().execute(() -> schools.postValue(spellSchoolDao.getAllSchools()));
    }
